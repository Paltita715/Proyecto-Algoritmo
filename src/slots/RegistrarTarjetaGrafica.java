...
public class RegistrarTarjetaGrafica extends javax.swing.JPanel {

    public RegistrarTarjetaGrafica() {
        initComponents();
        cargarProveedores();
    }
    ...
    private void initComponents() {
        ...
        add(jSeparator1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 50, 430, 10));
        ...
        add(btnEditar, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 520, 120, 50));
        ...
        add(btnCancelar, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 520, 120, 50));
        ...
        jLabel2.setText("ID");
        add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 140, 30, -1));
        ...
        add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 430, -1, -1));
        ...
        add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 240, -1, -1));

        jLabel9.setFont(new java.awt.Font("Roboto Medium", 1, 14)); // NOI18N
        jLabel9.setForeground(new java.awt.Color(51, 51, 51));
        jLabel9.setText("Cantidad");
        add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 430, -1, -1));
        add(txtMemoria, new org.netbeans.lib.awtextra.AbsoluteConstraints(670, 120, 210, 50));
        add(txtCantidad, new org.netbeans.lib.awtextra.AbsoluteConstraints(670, 410, 210, 50));
        add(txtAnchoBanda, new org.netbeans.lib.awtextra.AbsoluteConstraints(670, 310, 210, 50));

        txtPCIe.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "4", "8", "16" }));
        txtPCIe.setToolTipText("");
        add(txtPCIe, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 410, 210, 50));

        jLabel11.setFont(new java.awt.Font("Roboto Medium", 1, 14)); // NOI18N
        jLabel11.setForeground(new java.awt.Color(51, 51, 51));
        jLabel11.setText("Ancho de banda");
        add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 330, -1, -1));
        add(txtTipoMemoria, new org.netbeans.lib.awtextra.AbsoluteConstraints(670, 220, 210, 50));
