...
public class Login extends javax.swing.JFrame {
    ...
    public Login() {
        ...
        this.pintarImagen(lblAlan, "src/multimedia/alan.jpg");
        pnlAdmin admin = new pnlAdmin();
        admin.setSize(400, 230);
    ...
    private void initComponents() {
        ...
        bg.add(btnEntrar, new org.netbeans.lib.awtextra.AbsoluteConstraints(145, 400, 110, 40));
